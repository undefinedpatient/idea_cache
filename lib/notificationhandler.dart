...
class NotificationHandler {
  ...
  static Future<void> scheduleLocalNotification(
    ...
    Timer(secondCountDown, () async {
      ICNotification? instantNotification =
          await FileHandler.findNotificationById(notification.id);
  ...
  static Future<void> cancelNotification(ICNotification notification) async {
    await flutterLocalNotificationsPlugin.cancel(notification.scheduleId);
  }

  static Future<void> scheduleNotification(ICNotification notification) async {
